...
1、将IDA目录下的androidserver复制到手机data/local/tmp目录下

![Snipaste_2026-01-21_08-27-38](/images/Snipaste_2026-01-21_08-27-38.png)

![image-20260121085515551](/images/image-20260121085515551.png)

![image-20260121085543181](/images/image-20260121085543181.png)

2、提权

![image-20260121085715655](/images/image-20260121085715655.png)

3、用XAppDebug hook一下待调试的程序

![image-20260121090032275](/images/image-20260121090032275.png)

4、adb调试原理理解(补充)

![image-20260121092342338](/images/image-20260121092342338.png)

![image-20260121092408060](/images/image-20260121092408060.png)

![image-20260121092430525](/images/image-20260121092430525.png)

![image-20260121092443836](/images/image-20260121092443836.png)

5、IDA中加载so文件，在导出表中搜索java，若搜不到说明不是静态导出而是动态注册的再搜一下函数名

6、点Tab后显示类C语言，下断点

![image-20260121112644525](/images/image-20260121112644525.png)

7、启动应用，双击bat脚本

```bash
@echo on                                                                 %关闭回显命令%     
set device=127.0.0.1:5555                                                %指定使用哪个模拟器%
adb -s %device% forward tcp:23946 tcp:23946                              %端口转发,建立PC和Android设备之间的TCP连接通道，用于调试通信%
adb -s %device% shell am start -n com.zj.wuaipojie/.ui.ChallengeEight    %debug状态启动手机端APP%
adb -s %device% shell "su -c './data/local/tmp/android_server64'"        %以root身份在设备上运行一个本地调试工具/脚本（通常用于动态调试或注入%
pause
```

8、如果出现没root的情况在脸谱中开启root权限

![image-20260121114628388](/images/image-20260121114628388.png)

9、选择调试器

![image-20260121114717908](/images/image-20260121114717908.png)

10、打开进程选项

![image-20260121114819988](/images/image-20260121114819988.png)

![image-20260121114914308](/images/image-20260121114914308.png)

11、附加到进程

![image-20260121115254335](/images/image-20260121115254335.png)

12、查看断点和点击运行

![image-20260121145442203](/images/image-20260121145442203.png)

13、app中输入内容点击验证按钮

![image-20260121145607734](/images/image-20260121145607734.png)

14、ida中断点断下

![image-20260121145701798](/images/image-20260121145701798.png)

二、IDA trace

1、关键函数前后下两个断点

![image-20260121152423115](/images/image-20260121152423115.png)
...
![image-20260121152548886](/images/image-20260121152548886.png)

![image-20260121152740809](/images/image-20260121152740809.png)

5、选择trace的方式

![image-20260121152839335](/images/image-20260121152839335.png)

6、点击运行

![image-20260121153053896](/images/image-20260121153053896.png)

7、颜色变黄表示跑过了

![image-20260121153129635](/images/image-20260121153129635.png)
...
![image-20260123065921707](/images/image-20260123065921707.png)

2、设置环境变量

![image-20260123070150225](/images/image-20260123070150225.png)

3、创建虚拟环境并指定python版本

![image-20260123071307247](/images/image-20260123071307247.png)

4、常用命令

![image-20260123071851903](/images/image-20260123071851903.png)

![image-20260123071904460](/images/image-20260123071904460.png)

![image-20260123071929671](/images/image-20260123071929671.png)

![image-20260123072017431](/images/image-20260123072017431.png)

![image-20260123072047957](/images/image-20260123072047957.png)

5、下载server端，因为用的是雷电模拟器，所以选择，并将其移动到data/local/tmp中

![image-20260124093353067](/images/image-20260124093353067.png)

6、运行一下server端

![image-20260124093418311](/images/image-20260124093418311.png)

7、在虚拟环境中安装frida,环境版本必须一致，开VPN下载

```shell
pip install frida==16.2.1 frida-tools==12.3.0
```

![image-20260124093654152](/images/image-20260124093654152.png)

8、查看当前手机运行进程

![image-20260124095717384](/images/image-20260124095717384.png)

9、frida两种注入模式对比

![image-20260124095130316](/images/image-20260124095130316.png)

10、vscode中激活虚拟环境

```shell
# 1. 检查虚拟环境是否存在
dir D:\WORKON_HOME\frida16\Scripts\

# 2. 强制允许PowerShell执行脚本
Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope Process -Force

# 3. 激活虚拟环境
D:\WORKON_HOME\frida16\Scripts\Activate.ps1

# 4. 检查激活状态（应该看到 (frida16) 前缀）
# 如果看到 (frida16) PS D:\WORKON_HOME\frida16> 说明激活成功
```
...
![image-20260124110629914](/images/image-20260124110629914.png)
